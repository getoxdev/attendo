...
public class FragmentAccountAndSettings extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    binding.profileName.setText(snapshot.child(user_id).child("username").getValue(String.class));
                    binding.profileCollege.setText(snapshot.child(user_id).child("college").getValue(String.class));
                } else {
                    binding.profileName.setText("user_name");
                    binding.profileCollege.setText("institute_name");
                }
    ...
    private void initUI() {
        ...
        binding.viewAccount.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                fragmentManager.replace(R.id.container_frame, fragmentUserProfile)
                        .addSharedElement(binding.viewAccount, "card_expand_to_fit_screen")
        ...
        binding.editAttendanceCriterion.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        binding.routineSettings.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
...
//        binding.excel.setOnClickListener(new View.OnClickListener() {
//            @Override
//            public void onClick(View view) {
