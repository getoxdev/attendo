package com.example.attendo.ui.adapter;
...
import com.example.attendo.ui.main.drawers.AddEditAlarmActivity;
...
public final class AlarmsAdapter extends RecyclerView.Adapter<AlarmsAdapter.ViewHolder> {
    ...
    static final class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ViewHolder(View itemView) {
            ...
            label = itemView.findViewById(R.id.ar_lab);
            days = itemView.findViewById(R.id.ar_day);
