...
import com.example.attendo.service.AlarmReceiver;
import com.example.attendo.service.LoadAlarmsService;
import com.example.attendo.util.ViewUtils;
...
public class AddEditAlarmFragment extends Fragment {
   ...
   public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
     ...
     com.example.attendo.util.ViewUtils.setTimePickerTime(mTimePicker, alarm.getTime());
   ...
   private void save() {
      ...
      time.set(Calendar.MINUTE, com.example.attendo.util.ViewUtils.getTimePickerMinute(mTimePicker));
